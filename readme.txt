...
= 1.3.8 =
* Resolved error for discover button color.
...
= 1.4.1 =
* Added premium features information in header section,Service section and post setting.
...
* Resolved error for topbar search.
* Update POT file.
...
* Resolved css error for search box.
* Resolved css error for footer social icons.
* Tested upto WP v6.6
* Update POT file.
