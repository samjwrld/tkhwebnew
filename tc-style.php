<?php 
	...
	$interior_designs_btn_font_weight = get_theme_mod('interior_designs_btn_font_weight');{
	$interior_designs_custom_css .='.service-btn a, #comments input[type="submit"].submit{';
	$interior_designs_custom_css .='font-weight: '.esc_attr($interior_designs_btn_font_weight).';';
	$interior_designs_custom_css .='}';
	}   		
	...
	$interior_designs_footer_icon_font_size = get_theme_mod('interior_designs_footer_icon_font_size');
	$interior_designs_custom_css .='#footer .socialicons i{';
	$interior_designs_custom_css .='font-size: '.esc_attr($interior_designs_footer_icon_font_size).'px;';
	$interior_designs_custom_css .='}';	

	//Footer Social Icon Alignment
	$interior_designs_footer_icon_alignment = get_theme_mod( 'interior_designs_footer_icon_alignment','Center');
    if($interior_designs_footer_icon_alignment == 'Left'){
		$interior_designs_custom_css .='#footer .socialicons{';
			$interior_designs_custom_css .='text-align:start;';
		$interior_designs_custom_css .='}';
	}else if($interior_designs_footer_icon_alignment == 'Center'){
		$interior_designs_custom_css .='#footer .socialicons{';
			$interior_designs_custom_css .='text-align:center;';
		$interior_designs_custom_css .='}';
	}else if($interior_designs_footer_icon_alignment == 'Right'){
		$interior_designs_custom_css .='#footer .socialicons{';
			$interior_designs_custom_css .='text-align:end;';
		$interior_designs_custom_css .='}';
	}
	...
	$interior_designs_responsive_preloader_hide = get_theme_mod('interior_designs_responsive_preloader_hide',true);
