            ...
            <div id="footer">
            	<div class="container">
                    ...
                    <div class="socialicons col-lg-12 col-md-12 col-12 align-self-center">                      
                        ...
                        <?php } ?>    
                        <?php if( get_theme_mod( 'interior_designs_footer_linkedin_url' ) != '' && get_theme_mod('interior_designs_footer_linkedin_icon') != 'None') { ?>
                            <a target="_blank" href="<?php echo esc_url( get_theme_mod( 'interior_designs_footer_linkedin_url','' ) ); ?>"><i class="<?php echo esc_attr(get_theme_mod('interior_designs_footer_linkedin_icon','fab fa-linkedin')); ?>"></i><span class="screen-reader-text"><?php esc_html_e( 'Linkedin','interior-designs' );?></span></a>
                        <?php } ?> 
                        <?php if( get_theme_mod( 'interior_designs_footer_youtube_url' ) != '' && get_theme_mod('interior_designs_footer_youtube_icon') != 'None') { ?>
                            <a target="_blank" href="<?php echo esc_url( get_theme_mod( 'interior_designs_footer_youtube_url','' ) ); ?>"><i class="<?php echo esc_attr(get_theme_mod('interior_designs_footer_youtube_icon','fab fa-youtube')); ?>"></i><span class="screen-reader-text"><?php esc_html_e( 'Youtube','interior-designs' );?></span></a>
                        <?php } ?>                         
                    </div>
                    <?php } ?>    
