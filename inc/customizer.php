...
function interior_designs_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting('interior_designs_slider_arrow',array(
		'default' => 'true',
		'sanitize_callback'	=> 'interior_designs_sanitize_checkbox'
	 ));
	 
	 $wp_customize->add_control('interior_designs_slider_arrow',array(
		'type' => 'checkbox',
		'label' => __('Show / Hide slider Arrow','interior-designs'),
		'section' => 'interior_designs_slidersettings',
	 ));	
	...
	// Button Settings
	$wp_customize->add_section( 'interior_designs_button_option', array(
		'title' => __('Button Settings','interior-designs'),
		'panel' => 'interior_designs_panel_id',
	));
	...
	$wp_customize->add_control( 'interior_designs_post_button_text', array(
		...
		'section'     => 'interior_designs_button_option',
		'type'        => 'text',
	...
	$wp_customize->add_setting('interior_designs_btn_font_weight',array(
		'default'=> '',
		'sanitize_callback'	=> 'interior_designs_sanitize_choices',
	));
	$wp_customize->add_control('interior_designs_btn_font_weight',array(
		'label'	=> __('Button Font Weight','interior-designs'),
		'section'=> 'interior_designs_button_option',
		'type' => 'select',
		'choices' => array(
...
$wp_customize->add_setting('interior_designs_footer_linkedin_url',array(
	'default'	=> '',
	'sanitize_callback'	=> 'esc_url_raw'
));	
$wp_customize->add_control('interior_designs_footer_linkedin_url',array(
	'label'	=> __('Add Linkedin link','interior-designs'),
	'section'	=> 'interior_designs_social_icons_section',
	'setting'	=> 'interior_designs_footer_linkedin_url',
	'type'	=> 'url'
));
$wp_customize->add_setting('interior_designs_footer_linkedin_icon',array(
	'default'	=> 'fab fa-linkedin-in',
	'sanitize_callback'	=> 'sanitize_text_field'
));	
$wp_customize->add_control(new Interior_Designs_Icon_Changer(
	$wp_customize, 'interior_designs_footer_linkedin_icon',array(
	'label'	=> __('Linkedin Icon','interior-designs'),
	'section'	=> 'interior_designs_social_icons_section',
	'type'		=> 'icon'
)));
$wp_customize->add_setting('interior_designs_footer_youtube_url',array(
	'default'	=> '',
	'sanitize_callback'	=> 'esc_url_raw'
));	
$wp_customize->add_control('interior_designs_footer_youtube_url',array(
	'label'	=> __('Add Youtube link','interior-designs'),
	'section'	=> 'interior_designs_social_icons_section',
	'setting'	=> 'interior_designs_footer_youtube_url',
	'type'	=> 'url'
));
$wp_customize->add_setting('interior_designs_footer_youtube_icon',array(
	'default'	=> 'fab fa-youtube',
	'sanitize_callback'	=> 'sanitize_text_field'
));	
$wp_customize->add_control(new Interior_Designs_Icon_Changer(
	$wp_customize, 'interior_designs_footer_youtube_icon',array(
	'label'	=> __('Youtube Icon','interior-designs'),
	'section'	=> 'interior_designs_social_icons_section',
	'type'		=> 'icon'
)));
$wp_customize->add_setting( 'interior_designs_footer_icon_font_size', array(
	'default'           => '',
	'sanitize_callback' => 'interior_designs_sanitize_float',
) );
$wp_customize->add_control( 'interior_designs_footer_icon_font_size', array(
	'label' => __( 'Icon Font Size','interior-designs' ),
	'section'     => 'interior_designs_social_icons_section',
	'type'        => 'number',
	'input_attrs' => array(
		'step' => 1,
...
$wp_customize->add_setting('interior_designs_footer_icon_alignment',array(
	'default' => 'Center',
	'sanitize_callback' => 'interior_designs_sanitize_choices'
));
$wp_customize->add_control('interior_designs_footer_icon_alignment',array(
	'type' => 'select',
	'label' => __('Icon Alignment','interior-designs'),
	'section' => 'interior_designs_social_icons_section',
	'choices' => array(
		'Left' => __('Left','interior-designs'),
		'Right' => __('Right','interior-designs'),
